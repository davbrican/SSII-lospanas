...
public class MainActivity extends AppCompatActivity {
    ...
    private void showDialog() throws Resources.NotFoundException {
        ...
        if(condicion){
            ...
            Log.i("probando", "pasa por aqui 1");
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int whichButton) {
                                        Log.i("probando", "pasa por aqui 4");
                                        ...
                                        String pedidoFirmado = "";
                                        Log.i("probando", "pasa por aqui 5");
                                        Log.i("probando", privateKeyBytes.toString());
                                        try {
                                            keyFactory = KeyFactory.getInstance("RSA");
                                            Log.i("probando", "pasa por aqui 6");

                                            PrivateKey privateKey = keyFactory.generatePrivate(spec);
                                            Log.i("probando", "pasa por aqui 66");

                                            Signature sg = Signature.getInstance("SHA256withRSA");
                                            Log.i("probando", "pasa por aqui 666");

                                            sg.initSign(privateKey);
                                            Log.i("probando", "pasa por aqui 6666");

                                            sg.update(pedido.getBytes());

                                            Log.i("probando", "pasa por aqui 66666");

                                            // Firma
                                            byte[] firma = sg.sign();
                                            pedidoFirmado = firma.toString();
                                            Log.i("probando", "pasa por aqui 7");
                                        ...
                                        // 3. Enviar los datos
                                        try {
                                            Log.i("probando", "pasa por aqui 8");

                                            Socket socket = new Socket();
                                            Log.i("probando", "pasa por aqui 9");
